 ...
 */
final class Version20240408112526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT NOT NULL, image_id INT DEFAULT NULL, name TEXT NOT NULL, price DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
